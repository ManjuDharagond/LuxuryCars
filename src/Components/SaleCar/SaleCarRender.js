...
const SaleCar = () => {
  ...
  return (
    <div
      ...
      style={{ maxWidth: "1358px", maxHeight: "5000px", marginTop: "20px", marginBottom:"5vh" }}
    >
      <h3 className="text-center sale-car-top-title">
        We Have Everything You Need
      </h3>

      {screenWidth < targetWidth && !seeMore ? (
        <div className="row mx-auto">
          <div className="col-md-6 col-12 col-lg-3 mb-5">
            <div className="card sale-car-card mx-auto">
              ...
              <div className="card-body sale-car-details">
                ...
                <p className="w-100 mt-3 text-center sale-car-price-p">
                  10.000$
                </p>
          ...
          <div
            className="text-center sale-care-see-more"
            onClick={() => {
              setSeeMore(true);
            }}
          >
            ...
            >
              <g clip-path="url(#clip0_1_661)">
                <path d="M22 12L18 8V11H3V13H18V16L22 12Z" fill="#21408E" />
              </g>
              <defs>
